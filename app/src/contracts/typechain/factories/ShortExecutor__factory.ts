...
import type { ShortExecutor, ShortExecutorInterface } from "../ShortExecutor";
...
export class ShortExecutor__factory {
  static readonly abi = _abi;
  static createInterface(): ShortExecutorInterface {
    return new utils.Interface(_abi) as ShortExecutorInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ShortExecutor {
    return new Contract(address, _abi, signerOrProvider) as ShortExecutor;
  }
}
