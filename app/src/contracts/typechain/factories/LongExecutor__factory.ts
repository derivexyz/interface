...
import type { LongExecutor, LongExecutorInterface } from "../LongExecutor";
...
export class LongExecutor__factory {
  static readonly abi = _abi;
  static createInterface(): LongExecutorInterface {
    return new utils.Interface(_abi) as LongExecutorInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LongExecutor {
    return new Contract(address, _abi, signerOrProvider) as LongExecutor;
  }
}
