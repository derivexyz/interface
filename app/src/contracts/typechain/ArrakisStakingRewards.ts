...
export interface ArrakisStakingRewardsInterface extends utils.Interface {
  functions: {
...
export interface ArrakisStakingRewards extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArrakisStakingRewardsInterface;
