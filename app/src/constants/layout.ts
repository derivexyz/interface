...
export const EARN_VAULTS_CARD_GRID_COLUMN_TEMPLATE = ['1fr 36px', '1.5fr 1fr 1fr 1fr 1fr 1fr']
export const EARN_REFERRALS_CARD_GRID_COLUMN_TEMPLATE = ['1fr 36px', '1.5fr 1fr 1fr 1fr 1fr']
