...
const RewardsWethLyraL2UnstakeModalContent = withSuspense(
  ({ amount, onChange, onUnstake }: Props) => {
    ...
    const handleClickUnstake = useCallback(async () => {
      if (account) {
        ...
        execute(tx, TransactionType.UnstakeWethLyraL2, {
          onComplete: () => {
...
export default RewardsWethLyraL2UnstakeModalContent
