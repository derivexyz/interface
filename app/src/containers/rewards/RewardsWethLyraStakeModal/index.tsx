...
import RewardsWethLyraStakeModalContent from './RewardsWethLyraStakeModalContent'
...
export default function RewardsWethLyraStakeModal({ isOpen, onClose }: Props) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Stake WETH/LYRA">
      <CardBody>
        ...
        <RewardsWethLyraStakeModalContent
          amount={amount}
