...
export declare namespace OptionMarketViewer {
  ...
  export type LiquidityBalanceStruct = {
    ...
    quoteSymbol: string
    quoteDepositAllowance: BigNumberish
    liquidityToken: string
    liquidityBalance: BigNumberish
  }

  export type LiquidityBalanceStructOutput = [string, BigNumber, string, BigNumber, string, BigNumber] & {
    quoteAsset: string
  ...
  export type MarketViewWithBoardsStruct = {
    ...
    minSpotPrice: BigNumberish
    maxSpotPrice: BigNumberish
    quoteSymbol: string
  ...
  export type MarketsViewStructOutput = [boolean, OptionMarketViewer.MarketViewStructOutput[]] & {
    isPaused: boolean
...
export interface OptionMarketViewerInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'getBoardForBase', values: [string, BigNumberish]): string
  encodeFunctionData(functionFragment: 'getBoardForStrikeId', values: [string, BigNumberish]): string
  encodeFunctionData(functionFragment: 'getLiquidityBalances', values: [string]): string
  ...
  encodeFunctionData(functionFragment: 'getMarketForBase', values: [string]): string
  ...
  decodeFunctionResult(functionFragment: 'getLiquidityBalances', data: BytesLike): Result
...
export interface OptionMarketViewer extends BaseContract {
  ...
  getMarkets(markets: string[], overrides?: CallOverrides): Promise<OptionMarketViewer.MarketsViewStructOutput>
  ...
  callStatic: {
    ...
    init(_exchangeAdapter: string, overrides?: CallOverrides): Promise<void>
  ...
  estimateGas: {
    ...
    getBoardForBase(baseSymbol: string, boardId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>

    getBoardForStrikeId(market: string, strikeId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>

    getLiquidityBalances(account: string, overrides?: CallOverrides): Promise<BigNumber>
    ...
    getMarketForBase(baseSymbol: string, overrides?: CallOverrides): Promise<BigNumber>

    getMarkets(markets: string[], overrides?: CallOverrides): Promise<BigNumber>

    getOwnerPositions(account: string, overrides?: CallOverrides): Promise<BigNumber>

    init(_exchangeAdapter: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    getBoardForBase(baseSymbol: string, boardId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>
    ...
    getLiquidityBalances(account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>
    ...
    getMarketForBase(baseSymbol: string, overrides?: CallOverrides): Promise<PopulatedTransaction>

    getMarkets(markets: string[], overrides?: CallOverrides): Promise<PopulatedTransaction>

    getOwnerPositions(account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>
