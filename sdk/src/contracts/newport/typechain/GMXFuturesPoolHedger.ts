...
export declare namespace IFuturesPoolHedger {
  export type FuturesPoolHedgerParametersStruct = {
    maximumDelta: BigNumberish;
    maximumFundingRatePerDelta: BigNumberish;
    deltaThreshold: BigNumberish;
    marketDepthBuffer: BigNumberish;
    minKeeperGas: BigNumberish;
  };
...
export interface GMXFuturesPoolHedgerInterface extends utils.Interface {
  contractName: "GMXFuturesPoolHedger";
  functions: {
...
export type ApprovalsUpdatedEvent = TypedEvent<[boolean], { state: boolean }>;
...
export type CollateralUpdatedEvent = TypedEvent<
  [BigNumber, BigNumber],
  { newCollat: BigNumber; oldCollat: BigNumber }
>;
...
export type QueueNotEmptyEvent = TypedEvent<[BigNumber], { length: BigNumber }>;
...
export interface GMXFuturesPoolHedger extends BaseContract {
  ...
  functions: {
    ...
    canHedge(
      poolDeltaChange: BigNumberish,
      deltaIncrease: boolean,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
